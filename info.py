...
PICS = (environ.get('PICS', 'https://telegra.ph/file/4df46facb0cf1552bc364.jpg https://telegra.ph/file/93146bff697a2b676a9f0.jpg https://telegra.ph/file/d7eb179a9af4c3ca7b789.jpg https://telegra.ph/file/9a949d7cf395b816fabdb.jpg https://telegra.ph/file/c74a8c15d151ec754d63c.jpg https://telegra.ph/file/74a0d16f5cc85e5931d9d.jpg')).split()
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Mybot")
...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '5843384805').split()]
LAZY_RENAMERS = (lazy_renamers + ADMINS) if lazy_renamers else []
REQ_CHANNEL = int(environ.get('REQ_CHANNEL'))

#ai
OPENAI_API = environ.get("OPENAI_API","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")
AI = is_enabled((environ.get("AI","True"), False)
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1002127206441")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]

# Requested Content template variables ---
ADMIN_USRNM = environ.get('ADMIN_USRNM','Tamcine_abot') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','𝙏𝙖𝙢𝙞𝙡 𝘾𝙞𝙣𝙚𝙢𝙖𝙨 𝙃𝘿') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','𝐓𝐂 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 🔗 𝐋𝐢𝐧𝐤') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','Tamcine_abot')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "𝐓𝐂 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 🔗 𝐋𝐢𝐧𝐤") #[ without @ ]
