    ...
    if AI == True: 
        ...
        if user_id:
            try:
                ...
                footer_credit = "🦋<a href='https://telegram.me/{SUPPORT_CHAT}'>• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •</a>══<a href='https://t.me/tamcinemas'>• ᴄᴏɴᴛᴀᴄᴛ ᴍᴀꜱᴛᴇʀ •</a>🦋"
                ...
                print(error)
                await message.reply_text(f'Error aa gya my Bhaiya 😀\n\n{error}')
    else:
        return
